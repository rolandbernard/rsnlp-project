* The project domain, the attacked problem, the techniques and the obtained results, if any, must be described in a report (~ 5.000 words). System prototype implementation for the RS is optional; an actual evaluation of the NLP model is recommended.
...
* Write your report in LaTeX, 4-5 pages max, you can use the ACL latex style
  * Possible structure:
    ...
    * Related Work
    * Experiment (method, metrics, data)
    * Results
    * Conclusion
